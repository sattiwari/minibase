 ...
 * single DbFile. DbFiles can fetch pages and iterate through tuples. Each file
...
public interface DbFile {
    ...
    /**
     * Inserts the specified tuple to the file on behalf of transaction. This
     * method will acquire a lock on the affected pages of the file, and may block
     * until the lock can be acquired.
     *
     * @param tid The transaction performing the update
     * @param t The tuple to add. This tuple should be updated to reflect that it
     *          is now stored in this file.
     ...
     * transaction. This method will acquire a lock on the affected pages of the
     * file, and may block until the lock can be acquired.
     *
     * @throws DbException if the tuple cannot be deleted or is not a member of
     *           the file
     */
    ...
    /**
     * Returns an iterator over all the tuples stored in this DbFile. The iterator
     * must use {@link BufferPool#getPage}, rather than {@link #readPage} to
     ...
     * ensure that each HeapFile has a "unique id," and that you always return the
     * same value for a particular HeapFile. A simple implementation is to use the
     * hash code of the absolute path of the file underlying the HeapFile, i.e.
