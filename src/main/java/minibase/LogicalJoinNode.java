...
/**
 * A LogicalJoinNode represens the state needed of a join of two tables in a
 * LogicalQueryPlan
 */
public class LogicalJoinNode {

    /**
     * The first table to join (may be null). It's the alias of the table (if no
     * alias, the true table name)
     */
    public String t1Alias;

    /**
     * The second table to join (may be null). It's the alias of the table, (if no
     * alias, the true table name).
     */
    public String t2Alias;

    /**
     * The name of the field in t1 to join with. It's the pure name of a field,
     * rather that alias.field.
     */
    ...
    /**
     * Return a new LogicalJoinNode with the inner and outer (t1.f1 and t2.f2)
     * tables swapped.
     */
