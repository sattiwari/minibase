 ...
 * <p>
 * Pages may be "dirty", indicating that they have been modified since they were
 * last written out to disk.
 *
...
public interface Page {
    ...
    /**
     * Return the id of this page. The id is a unique identifier for a page that
     * can be used to look up the page on disk or determine if the page is
    ...
    /**
     * Get the id of the transaction that last dirtied this page, or null if the
     * page is clean..
     *
     ...
     * generated by getPageData to the Page constructor and have it produce an
    ...
    /**
     * Provide a representation of this page before any modifications were made to
     * it. Used by recovery.
     */
