 ...
 * minibase.Debug. For example, on the command line, use -Dminibase.Debug=x,
 * or simply -Dminibase.Debug to enable it at level 0.
...
public class Debug {
    ...
    static {
        String debug = System.getProperty("minibase.Debug");
        if (debug == null) {
