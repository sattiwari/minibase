...
import minibase.Predicate.Op;

public class IntHistogramTest {

    /**
     * Test to confirm that the IntHistogram implementation is constant-space (or,
     * at least, reasonably small space; O(log(n)) might still work if your
     * constants are good).
     */
    @Test
    public void orderOfGrowthTest() {
        // Don't bother with a timeout on this test.
        // Printing debugging statements takes >> time than some inefficient
        // algorithms.
        ...
        for (int c = 0; c < 33554432; c++) {
            h.addValue((c * 23) % 101); // Pseudo-random number; at least get a
            // distribution
        }
