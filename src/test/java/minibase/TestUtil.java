...
public class TestUtil {
     ...
     * tuple pair in parallel iteration satisfies compareTuples . If not, throw an
     * assertion.
     */
    public static void compareDbIterators(DbIterator expected, DbIterator actual) throws DbException,
     ...
     * assertion.
     */
    public static void matchAllTuples(DbIterator expected, DbIterator actual) throws DbException,
            TransactionAbortedException {
     ...
     */
    public static boolean checkExhausted(DbIterator it) throws TransactionAbortedException,
            DbException {
...
//        @Override
    ...
    public static class MockScan implements DbIterator {
         ...
         * fields, each with the same value, that increases from low (inclusive) and
         * high (exclusive) over getNext calls.
         */
